...
/* Bitfields inside a PACKED UNION, read back thro￾ view — the shape
 ...
 * every read.
 *
 * `90_bitfields` covers bitfield l(n its own. `91_union_type_punning`
...
/* CONTROL: the same three fields as ordi"bers, with no bitfields, no
