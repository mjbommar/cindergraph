 ...
 * NOT triggering it, and the corpus only cλhose:
 *
 ...
 * sentinel, no counter. Do not add a step bound here -- a second exi(is
 ...
 * so this pins the SET of nodes visited: theλ nodes must come back
