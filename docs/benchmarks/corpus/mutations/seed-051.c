 ...
 * `(v | 1)
1` to 1, say — must get the whole identity right; getting it half
...
/*#if X
 + 1)` is the product of two consecutive integers, hence even; the
...
/* A two-way opaque predicate: the condition gen