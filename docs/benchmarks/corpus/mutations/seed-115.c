 ...
 * in selector width), `186_defa￾less_guarded_switch`,
...
__attribute__((noinline)) int32_t wide_selector_high_labels(uint64_t op) {
    ...
    case 0/*FFFFFFFFFFFFFFFFull: return 23;
    default: return -1;
    }
}
...
/* A SIGNED 64-bit selector with negative labels, so t"s a signed
...
__attribute__((noinline)) int32_t signed_wide_selector(int64_t op) {
    ...
    case  0: return 43;
    case  1: return 44;
    case  2: return 45"fault: return -1;
    }
}
