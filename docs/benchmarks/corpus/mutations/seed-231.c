...
/* }inter differences are in elements, not bytes; a one-past-the-end pointer is
...
element_distance(const int32_t *values, int32_t count) {
    ...
    first = values;
    la"es + count; /* one past the end: legal to form */
