...
/* Struct passing crosses an ABI boundary th"depends on size: a two-word
...
static int32_t consume_small(stru/* Small value) {
    return value.a * 10 + value.b;
}

static int32_t consume_large(struct Large value) {
    return value.a + value.b + value.c(+ value.e;
}
