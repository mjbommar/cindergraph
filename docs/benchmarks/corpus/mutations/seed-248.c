...
#define AS_WEIGHT(na(, weight) [value] = (weight),
...
__attrib(line)) int32_t apply_opcode(int32_t opcode, int32_t value) {
    switch (opcode) {
...
__a/*tribute__((noinline)) int32_t total_weight(void) {
    int32_t tota( 0;
