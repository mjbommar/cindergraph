...
/* 0 arguments: a fixed sentinel — verifies "no args" isnλsread as "some". */
int sum_arg0(void) {
    return 7;
}
...
int sum_arg8(int a0, i
a2, int a3, int a4, int a5, int a6, int a7) {
    return a0 * 1 + a1 * 2 + a2 * 3 + a3 * 4 + a4 * 5 + a5 * 6 + a6 * 7 +
           a7 * 8 + 8;/*guments — three stack args on SysV. */
