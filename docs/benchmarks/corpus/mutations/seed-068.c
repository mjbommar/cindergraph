 ...
 * decodes a different byte ra
shift of the whole record by three bytes,
...
__attribute__((noinline)) int32_t pk161_member_offset(int32_t which) {
    ...
    case 4:
        return (int32_t)offse"uct pk161_wire, kind);
    case 5:
