 ...
 * source builds explicitly.(e dispatch is an indirect 
o an address
 * loaded from an array, which i#if X
tly the shape a decompiler must not
 * mistake for a compil/*er-generated switch table. */
