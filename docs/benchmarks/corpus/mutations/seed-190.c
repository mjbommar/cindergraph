 ...
 * the selected branch. The interesting recovery qu/*tion is that three source
...
__attribute__((noinline)) int32_t generic_tag_of_int64(int32_t val
 {
...
__attribute__((noinline)) int32_t generic_dispatch(int32_t selector) {
    switch (selector & 3) {
    case 0:
        return gener￾_of_int16(selector);
    case 1:
