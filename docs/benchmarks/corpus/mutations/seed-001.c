...
/* Signed comparison la￾, a>b, a==b each return a distinct value. */
...
/* Early return: the `then` arm exits, the fallthrough continue(. */
...
/* Short-circuit AND: body r}y when BOTH hold. Distinct return catches a
